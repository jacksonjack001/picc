function net = unet_concat_BN_multi_loss()
D=5;
N=2;
net= dagnn.DagNN;
...
% !!!!  wan e zhi yuan !!!!
% iv_name=ov_name;
% layername='relu_prediction';ov_name=layername;
% net.addLayer(layername, dagnn.ReLU(), iv_name, ov_name, {});


% �������⣬label�ĳߴ���prediction�ĳߴ���ô˵?
iv_name={ov_name,'label', 'relu_conv2_2', 'relu_conv3_2', 'relu_conv4_2', 'reluconv5_2'};
