function unet_concat_train_noCrop_mLoss(varargin)
...
opts.expDir = 'data/picc/mLoss_noT_20_20_20/' ;
...
trainOpts.learningRate = [0.1 * ones(1,20) 0.01 * ones(1,20) 0.001 * ones(1,20)];
