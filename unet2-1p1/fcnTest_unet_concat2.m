function info = fcnTest_unet_concat2(varargin)
...
opts.modelPath = 'exp/net-epoch-100.mat' ;
...
% Get PASCAL VOC 11/12 segmentation dataset plus Berkeley's additional segmentations
...
%     scores_ = cat(3,aa,bb) ;
    ...
    % Save segmentation
    save_pred_color = [opts.expDir, '/save_pred_color/'];
    save_pred_3_2 = [opts.expDir, '/save_pred_3_view/'];
